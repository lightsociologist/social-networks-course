...
sch23 <- read_graph("data/sch23.net", format="pajek")
...
school <- delete_vertices(sch23, isolates)
...
orwg(simplify(school), "sex")

```
```{r, message=FALSE}

orwg(simplify(school), "grade")
...
rg <- sample_gnm(length(V(school)), length(E(school)), directed=T)
